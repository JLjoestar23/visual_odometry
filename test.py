"""
Module to test the custom essential matrix implementation
"""

import numpy as np
import matplotlib.pyplot as plt
import cv2 as cv
from essential_matrix import find_essential_mat
...
def main():
    ...
    K = np.array([[300, 0, 150], [0, 300, 150], [0, 0, 1]])
    ...
    E_my = find_essential_mat(pts1, pts0, K)
    print("\nMy essential matrix:")
    print(E_my)
